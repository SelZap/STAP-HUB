...
document.addEventListener("DOMContentLoaded", function () {
    ...
    // --------------------------------------------------------
    document
        .querySelectorAll('input[name="people_hurt"]')
    ...
    function clearErrors() {
        ...
        document.querySelectorAll(".ir-err").forEach(function (el) {
            el.textContent = "";
        });
        document.querySelectorAll(".ir-input-invalid").forEach(function (el) {
            el.classList.remove("ir-input-invalid");
        });
    }
