    ...
    <form id="drForm" novalidate>
        ...
        <div class="dr-card">
            ...
            <div class="dr-grid-2">
                <div class="stap-form-group">
                    ...
                    <input type="text" id="requester_name" name="requester_name" class="stap-form-input" placeholder="e.g. Juan dela Cruz" required>
                ...
                <div class="stap-form-group">
                    ...
                    <input type="text" id="requester_organization" name="requester_organization" class="stap-form-input" placeholder="e.g. University of the Philippines">
                </div>
            </div>
            <div class="stap-form-group">
                <label class="stap-form-label" for="requester_address">Address</label>
                <input type="text" id="requester_address" name="requester_address" class="stap-form-input" placeholder="Street, City, Province">
            </div>
            <div class="dr-grid-2">
                <div class="stap-form-group">
                    <label class="stap-form-label" for="requester_email">Email Address <span class="dr-req">*</span></label>
                    <input type="email" id="requester_email" name="requester_email" class="stap-form-input" placeholder="your@email.com" required>
                ...
                <div class="stap-form-group">
                    ...
                    <input type="tel" id="requester_contact" name="requester_contact" class="stap-form-input" placeholder="e.g. 09171234567" required>
        ...
        <div class="dr-card">
            ...
            <div class="stap-form-group" id="otherReasonWrap" style="display:none;">
                ...
                <input type="text" id="other_reason" name="other_reason" class="stap-form-input" placeholder="Describe the purpose of your request...">
        ...
        <div class="dr-card dr-card-optional">
            ...
            <div class="stap-form-group">
                ...
                <input type="text" id="names_involved" name="names_involved" class="stap-form-input" placeholder="e.g. Pedro Manalo, driver of white Toyota">
            </div>
            <div class="stap-form-group">
                <label class="stap-form-label" for="incident_description">Incident Description</label>
                <textarea id="incident_description" name="incident_description" class="stap-form-input dr-textarea" placeholder="Briefly describe what happened..."></textarea>
            </div>
        </div>
        ...
        <div class="dr-submit-row">
            ...
            <p class="dr-submit-note">Our team will review your request and respond to your email within 3–5 business days.</p>
        </div>
    </form>
</div>
@endsection
