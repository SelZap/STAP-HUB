...
@push('styles')
<style>
    .ir-modal-grid      { display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:16px; }
    .ir-field           { background:#f8fafc;border-radius:8px;padding:10px 12px; }
    .ir-field-label     { font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;color:#64748b;margin-bottom:4px; }
    .ir-field-value     { font-size:13px;font-weight:600;color:#0f172a;line-height:1.4; }
    .ir-field-full      { grid-column:1/-1; }
    .ir-section-title   { font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.06em;color:#64748b;margin:18px 0 10px;padding-bottom:6px;border-bottom:1px solid #e2e8f0; }
    .ir-modal-header    { display:flex;align-items:flex-start;justify-content:space-between;gap:12px;margin-bottom:16px; }
    .ir-modal-title     { font-size:17px;font-weight:800;color:#0f172a;margin:0; }
...
<div class="stap-modal-overlay" id="reportModal">
    <div class="stap-modal" style="width:720px;max-width:calc(100vw - 32px);max-height:90vh;overflow-y:auto;border-radius:14px;">
